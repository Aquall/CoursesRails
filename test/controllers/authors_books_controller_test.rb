...
class AuthorsBooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create authors_book" do
    assert_difference("AuthorsBook.count") do
      post authors_books_url, params: { authors_book: { book_id: @authors_book.book_id, genre_id: @authors_book.genre_id } }
    end
  ...
  test "should update authors_book" do
    patch authors_book_url(@authors_book), params: { authors_book: { book_id: @authors_book.book_id, genre_id: @authors_book.genre_id } }
